...
--rollback ALTER TABLE ADDRESSES DROP FOREIGN KEY ORG_FK1;
...
ALTER TABLE EMPLOYEES
    ...
    FOREIGN KEY (ORG_ID)
    REFERENCES ORGANIZATIONS(ID);
--rollback ALTER TABLE EMPLOYEES DROP FOREIGN KEY ORG_FK2;

--changeset molivas:sp_create_getemployeesbyorg labels:release-1.2.0 splitStatements:false
--comment Release 1.2.0
CREATE PROCEDURE get_employees_by_org(IN p_org_id INT)
BEGIN
